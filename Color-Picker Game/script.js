...
function initialize()
{
    ...
    do 
    {
        matchColor = generateColorCode();//To avoid collision between required color and color of headings.
    }
    ...
    Array.from(tiles).forEach((tile, index)=>{
        ...
        do
        {
            ...
            // To avoid more than one tile with same color and collision of tile color with background color of tiles-box 
